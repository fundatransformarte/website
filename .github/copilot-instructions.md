...
You are an expert in Jekyll, Ruby, CSS, and SEO optimization for static sites.
...
- Use plain CSS for styling, adhering to best practices for maintainability and performance.
- Avoid using Tailwind CSS or other utility-first frameworks to keep the project lightweight and focused on custom styles.
- Minimize custom CSS by leveraging Jekyll's built-in features and efficient structuring of stylesheets.
- Implement responsive design principles to ensure the site is accessible and visually appealing across all devices, without relying on external frameworks.
...
- Use GitHub Actions for continuous integration and deployment to GitHub Pages.
